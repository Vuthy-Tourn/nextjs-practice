...
export default function UserCard({id, firstName, lastName, role, image, university}:UserType) {
  return (
    <div
      key={id}
      className="bg-white rounded-xl shadow-2xl max-w-sm w-full overflow-hidden transition-all duration-300 hover:shadow-indigo-500/50 dark:hover:shadow-blue-900/50"
    >
