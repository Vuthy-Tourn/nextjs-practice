...
export default function UserDetailPage({ params }: PageProps) {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://img.freepik.com/premium-vector/futuristic-digital-interface-element-background_57516-2039.jpg')",
      }}
    >
      <div className="max-w-4xl mx-auto py-20 flex items-center justify-center min-h-screen">
        <div className="w-full md:flex shadow-2xl rounded-lg overflow-hidden bg-white bg-opacity-90">
          ...
          <div className="md:w-2/3 p-6 text-center md:text-left">
            ...
            {user.email && (
              <p className="mt-4 text-sm text-gray-700">{user.email}</p>
            )}
